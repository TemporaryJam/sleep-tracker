        ...
        <div className="font-sans bg-gray-100 text-gray-800">
            ...
            <section className="flex flex-col items-center justify-center text-center py-16 px-8 bg-gray-100">
                ...
                <p className="text-lg md:text-xl bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent">
                    Your ultimate companion for tracking sleep and improving
                    your health.
                </p>
            </section>
            ...
            <section className="py-16 px-8 bg-white">
                ...
                <p className="text-gray-600 max-w-3xl mx-auto text-center">
                    At SleepTracker, we aim to help individuals achieve better
                    sleep and overall well-being by providing insights into
                    their sleep patterns. Better sleep leads to a healthier,
                    happier life, and we’re here to guide you every step of the
                    way.
                </p>
            </section>
            ...
            <section className="py-16 px-8 bg-gray-100">
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-md shadow">
                        ...
                        <p className="text-gray-600">
                            Enjoy an intuitive and seamless experience across
                            all devices.
                        </p>
                    </div>
                </div>
            ...
            <section className="py-16 px-8 bg-white">
                ...
                <p className="text-gray-600 max-w-3xl mx-auto text-center">
                    SleepTracker was created to address the growing need for
                    better sleep management tools. Our team of sleep experts and
                    technologists developed a platform that combines
                    cutting-edge technology with actionable insights. Since our
                    launch, we’ve helped countless users achieve better sleep
            ...
            <section className="py-16 px-8 bg-gray-100 text-center">
                ...
                <p className="text-lg mb-6 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent">
                    Join SleepTracker today and take the first step towards
